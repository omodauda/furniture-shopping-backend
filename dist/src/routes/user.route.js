...
class UserRoute {
    ...
    initializeRoutes() {
        ...
        this.router
            ...
            .get(auth_middleware_1.authMiddleware, this.AddressController.getUserAddress)
        ...
        this.router
            ...
            .patch(auth_middleware_1.authMiddleware, this.AddressController.setDefaultAddress);
    }
}
